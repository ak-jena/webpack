...
let LdHeaderWithChoices = class LdHeaderWithChoices extends LitElement {
    constructor() {
        super();
        this.choices = [];
  ...
  `;
    ...
    tapChoice(name) {
        ...
        this.dispatchEvent(new CustomEvent('selected-choices-changed', { detail: { value: selectedChoices, property: this.property } }));
    }
    updated(properties) {
    ...
    updateFilteredChoices() {
        this.filteredChoices = (this.enableFilter && this.choices)
            ? this.choices.filter((c) => { var _a, _b; return (_a = c === null || c === void 0 ? void 0 : c.label) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes((_b = this.filterValue) === null || _b === void 0 ? void 0 : _b.toLowerCase()); })
            : this.choices;
    }
};
__decorate([
    property({ type: Array })
], LdHeaderWithChoices.prototype, "choices", void 0);
__decorate([
    property({ type: Boolean })
], LdHeaderWithChoices.prototype, "enableFilter", void 0);
__decorate([
    property({ type: String })
], LdHeaderWithChoices.prototype, "filterValue", void 0);
__decorate([
    query('#filterInput')
], LdHeaderWithChoices.prototype, "filterInput", void 0);
__decorate([
    property({ type: Array })
], LdHeaderWithChoices.prototype, "filteredChoices", void 0);
__decorate([
    property({ type: Array })
], LdHeaderWithChoices.prototype, "selectedChoices", void 0);
__decorate([
    property({ type: String })
], LdHeaderWithChoices.prototype, "property", void 0);
__decorate([
    property({ type: Boolean })
], LdHeaderWithChoices.prototype, "opened", void 0);
__decorate([
    query('.dropdown')
], LdHeaderWithChoices.prototype, "dropdown", void 0);
LdHeaderWithChoices = __decorate([
    customElement('ld-header-with-choices')
], LdHeaderWithChoices);
export { LdHeaderWithChoices };
//# sourceMappingURL=ld-header-with-choices.js.map