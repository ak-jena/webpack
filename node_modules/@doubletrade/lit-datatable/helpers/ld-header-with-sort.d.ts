...
declare const LdHeaderWithSort_base: {
    new (...args: any[]): {
...
export declare class LdHeaderWithSort extends LdHeaderWithSort_base {
    direction: '' | 'asc' | 'desc';
    language: Language | null;
    resources: Resources | null;
    ...
    handleSort(): void;
    getTooltipText(direction: 'asc' | 'desc' | ''): string;
}
export {};
//# sourceMappingURL=ld-header-with-sort.d.ts.map