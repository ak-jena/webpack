...
let LitDatatableFooter = class LitDatatableFooter extends Localize(LitElement) {
    constructor() {
        super(...arguments);
        this.language = 'en';
        this.resources = {
    ...
    newSizeIsSelected({ currentTarget }) {
        const paperListBox = currentTarget;
...
], LitDatatableFooter.prototype, "footerPosition", void 0);
__decorate([
    property({ type: Number })
], LitDatatableFooter.prototype, "size", void 0);
__decorate([
    property({ type: Number })
], LitDatatableFooter.prototype, "page", void 0);
__decorate([
    property({ type: Number })
], LitDatatableFooter.prototype, "totalElements", void 0);
__decorate([
    property({ type: Number })
], LitDatatableFooter.prototype, "totalPages", void 0);
__decorate([
    property({ type: Array })
], LitDatatableFooter.prototype, "availableSize", void 0);
LitDatatableFooter = __decorate([
    customElement('lit-datatable-footer')
], LitDatatableFooter);
export { LitDatatableFooter };
//# sourceMappingURL=lit-datatable-footer.js.map